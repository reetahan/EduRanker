...
def run_single_simulation(
    ...
    all_chunks = []
    # (district, schools_list, sigma_indices, chunk_components, seed)
...
def EM_algorithm(df, match_stats_df, school_info_df,
                 ...
                 sampling_n_jobs=32, max_iter_opt=5, simulation_kwargs=None):
    """
    ...
    for iteration in range(max_iter):
        ...
        params, final_agg, total_log_like = optimize_global_mixture(
            ...
            executor=warm_executor, max_iter_em=max_iter, max_iter_opt=max_iter_opt, simulation_kwargs=simulation_kwargs
        )
...
def compute_log_likelihood_gaussian_all_districts(params_global, observed_agg,
                                                   ...
                                                   executor=None, sampling_n_jobs=32, simulation_kwargs=None):
    """
    ...
    for sim in range(M):
        ...
        agg = run_single_simulation(
            ...
            sampling_n_jobs=sampling_n_jobs, **simulation_kwargs
        )
...
def optimize_global_mixture(params, observed_agg, df, match_stats_df, 
                            ...
                            max_iter_em=5, max_iter_opt=5, simulation_kwargs=None):
    ...
    for k in range(K):
        ...
        def objective_global_phi_k(phi):
            ...
            total_log_lik = compute_log_likelihood_gaussian_all_districts(
                ...
                executor=executor, sampling_n_jobs=sampling_n_jobs, simulation_kwargs=simulation_kwargs
            )
