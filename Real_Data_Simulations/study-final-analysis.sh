...
#SBATCH --output=/scratch/rm6609/EduRanker/Real_Data_Simulations/job_final_analysis.log
...
echo "Final Analysis Start: $TIMESTAMP" 2>&1 | tee -a /scratch/rm6609/EduRanker/Real_Data_Simulations/job_final_analysis.log
